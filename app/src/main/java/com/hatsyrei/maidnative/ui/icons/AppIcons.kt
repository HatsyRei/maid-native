...
/** Material `tune` (Settings sampling button). */
...
/** Material `repeat` (Settings penalties button). */
val RepeatIcon: ImageVector by lazy {
    materialIcon("Repeat", "M7,7h10v3l4,-4 -4,-4v3H5v6h2V7zM17,17H7v-3l-4,4 4,4v-3h12v-6h-2v4z")
}
